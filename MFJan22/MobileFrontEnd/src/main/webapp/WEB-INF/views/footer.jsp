...
<nav class="navbar navbar-default" style="font-weight: bold;  width: 100% background-color: #66004d;">
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="starting"><font color="white">MOBILESTORE</font></a>
    </div>
    <ul class="nav navbar-nav">
      <li ><a href="contact_us"><font color="white"><b>Contact Us</b></font></a></li>
      <li ><a href="about_us"><font color="white"><b>Feedback</b></font></a></li>      
