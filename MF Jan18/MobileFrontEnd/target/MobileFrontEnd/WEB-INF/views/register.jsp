...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  {
  background-image: url("mobile5.jpg");
  }
   </style>
</head> 
<body>
...
<div class="form-group">
  ...
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
     <form:input type="phoneno" path="phoneno" class="form-control" placeholder="Enter Phoneno."/><br>
     </div>
     </div>
     </div>
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
     <form:input type="address" path="address" class="form-control" placeholder="Enter Address"/><br>
     </div>
     </div>
     </div>
     <div class="form-group">
